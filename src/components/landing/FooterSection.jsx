      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-10 pt-16 pb-4 lg:pt-20 lg:pb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[auto_1fr_1fr_max-content] gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            <div className="space-y-3">
              {['Carga em Geral', 'Modal Rodoviário', 'Frota Própria', 'Operações Personalizadas'].map((s) => (
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <span className="whitespace-nowrap">vaievemtransportes@vaievemtransportes.com.br</span>
              </a>
        ...
        <div className="mt-16 pt-8 border-t border-vv-navy/8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-xs text-vv-steel/60">
            {`© ${new Date().getFullYear()} Vai\u0026Vem Transportes. Todos os direitos reservados.`}
          </span>
          <span className="text-xs text-vv-steel/60">
            Desenvolvido por{' '}
            <a
